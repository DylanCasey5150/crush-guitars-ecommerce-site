...
export default function Navbar() {
    ...
    <Link to="/home"><img src={crushLogo} className="w-20 md:w-25" alt="Crush Logo" /></Link>
    <Link to="/home"><div className="text-xl font-bold">Crush</div></Link>
  </div>
        <ul className="flex gap-6 md:gap-10">
          
          <Link to="/guitars"><li className="hover:underline cursor-pointer">Guitars</li></Link>
          <Link to="/limited"><li className="hover:underline cursor-pointer">Limited Release</li></Link>
         ...
         <Link to="/account"> <li className="hover:underline cursor-pointer">Account</li></Link>
